node ('swarm'){
  ...
  withEnv(["PATH+MAVEN=${tool 'maven-3.3.1'}/bin"]) {
    ...
    def fabricMavenPluginVersion = '2.2.59'
    ...
    sh "mvn clean install -U org.apache.maven.plugins:maven-deploy-plugin:2.8.2:deploy org.jolokia:docker-maven-plugin:${dockerMavenPluginVersion}:build -Dfabric8.dockerUser=fabric8/ -Ddocker.registryPrefix=${registry}"
